...
public class WebGlobals {
	...
	public static final String VERSION_WEB_APP = "5.2.3";
	...
	private static List<String> maritalStatusValues = Arrays.asList("Single", "Married", "Widowed", "Divorced", "Engaged", "Refused");
//	public static final ArrayList<String> maritalStatusValues = new ArrayList<String>( Arrays.asList("Single", "Married", "Widowed", "Divorced", "Engaged", "Refused"));
