...
public class GlobalParams 
{
	...
	public enum ServiceLogType {
		RAPIDPRO_CONTACT_FULL_UPDATE,
		SMSTARSEEL_TELENOR_OUTBOUND_PUSH
	}
	...
	public static final String REMINDER_PUSHER_DEFAULT_CRON = "0 0 0/8 * * ?";
	...
	public static final String CHILD_PROGRAM_ID_IDENTIFIER_TYPE = "CHILD_PROJECT_ID";
	
	/* campaign start */		
	public static final String CAMPAIGN_CHILD_ROLE_NAME = "campaign_child";		
	/* campaign end */
